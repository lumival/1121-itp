...
for each_char in password:
    if each_char in uppercase:
        has_uppercase = True
    elif each_char in lowercase:
        has_lowercase = True
    elif each_char in special_char:
        has_special_char = True
    elif int(each_char) in range(0,10):
        has_number = True
...
if final_result == True:
    ...
    print("Update password, it's too weak")
